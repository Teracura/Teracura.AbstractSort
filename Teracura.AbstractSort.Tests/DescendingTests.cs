...
public class DescendingTests
{
    ...
    {
        var config = new SortConfig.Builder().SortAscending(false).ReturnType(ReturnType.Queue).Build();
    ...
    {
        var config = new SortConfig.Builder().SortAscending(false).ReturnType(ReturnType.HashSet).Build();
        config.Ascending.ShouldBeFalse();
    ...
    {
        var config = new SortConfig.Builder().SortAscending(false).ReturnType(ReturnType.Stack).Build();
        config.Ascending.ShouldBeFalse();
